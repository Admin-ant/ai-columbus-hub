      ...
      <div className="mx-auto max-w-7xl space-y-6">
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex gap-2">
            ...
            <Button onClick={onCompose} className="bg-[#ff2bd6] hover:bg-[#ff2bd6]/90 text-foreground">
              ...
              return (
                <button
                  ...
                  className={`flex w-full items-center justify-between rounded-md px-3 py-2 text-sm transition ${
                    active ? "bg-[#ff2bd6]/15 text-foreground" : "text-muted-foreground hover:bg-muted/50"
                  }`}
                >
                  ...
                  {f.count > 0 && (
                    <Badge className="bg-[#ff2bd6]/30 text-foreground text-[10px] px-1.5">{f.count}</Badge>
                  )}
                </button>
              );
            })}
                  ...
                  {folder === "inbox" && (
                    <>
                      <Button
                        ...
                        className="h-7 px-2 text-[11px] text-foreground hover:bg-muted"
                      >
                    ...
                    >
                      ...
                      <button onClick={() => onSelect(m)} className="flex-1 min-w-0 text-left">
                        ...
                        <div className="mt-1 flex items-center gap-2">
                          <StatusBadge m={m} />
                          {m.attachments?.length > 0 && <Paperclip className="h-3 w-3 text-muted-foreground" />}
                        </div>
                      </button>
                    </div>
                  );
    ...
    <div className="space-y-4">
      <div className="flex items-start justify-between gap-3">
        ...
        <div className="flex gap-2 shrink-0">
          ...
          <Button size="sm" onClick={onOpenCompose} className="bg-[#ff2bd6] hover:bg-[#ff2bd6]/90 text-foreground">
...
function MessageCard({
  ...
  return (
    <div className="rounded border border-border bg-black/20 p-3 text-sm">
      <div className="mb-2 flex items-start justify-between gap-2">
        <div className="min-w-0">
          <div className="text-xs text-foreground">
            <span className="font-medium">{m.from_name ?? m.from_email ?? "—"}</span>
            {m.from_email && m.from_name && (
              <span className="ml-1 text-muted-foreground">&lt;{m.from_email}&gt;</span>
            )}
          </div>
      ...
      {m.attachments?.length > 0 && (
        <div className="mt-3">
          <div className="mb-1 text-[10px] uppercase tracking-wider text-muted-foreground">Bijlagen</div>
            ...
            {m.attachments.map((a) => (
              ...
              >
                <div className="flex min-w-0 items-center gap-2">
                  ...
                  <div className="min-w-0">
                    <div className="truncate text-xs text-foreground">{a.filename}</div>
